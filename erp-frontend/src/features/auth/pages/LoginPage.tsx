                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                  ...
                  {error && (
                    <motion.p
                      ...
                      className="rounded-2xl border border-destructive/15 bg-destructive/5 px-4 py-3 text-sm leading-6 text-destructive"
                    >
                      {error}
                    </motion.p>
                  )}
                  ...
                  {showSlowLoginNotice && !error && (
                    ...
                    >
                      Still signing you in. Please keep this page open.
                    </motion.p>
                  )}
